...
void testcases() {
	...
	// ====================
	vector<Vertex> componentmap(V);	// We MUST use such a vector as an Exterior Property Map: Vertex -> Component
	...
	vector<Vertex>	kruskalpredmap(V), rankmap(V);	// We can use this vectors as Exterior Property Maps if we want to access additional information computed by Union-Find		
